...
public final class BridgeAssistModule extends Module implements PacketListener {
    ...
    // ── Static sneak state (read from patchMovementInput JVMTI hook) ────
    ...
    // ── Static patchMovementInput (called from JVMTI hook) ──────────────
     ...
     * and movement fields when BridgeAssist overrides sneak after vanilla ran.
     */
    public static void patchMovementInput(Object movInput) {
        ...
        try {
            ...
            VelocityModule.patchMovementInput(movInput);
